  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i> Tambah Pendapatan</button>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="<?= base_url('app/add_pendapatan') ?>">
                    <div class="form-group">
                      <label>Nama pendapatan</label>
                      <input type="text"  name="nama_pendapatan" class="form-control" required>
                    </div>
                   ...
                   <div class="modal fade" id="modalhapus<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form method="post" action="<?= base_url('app/hapus_pendapatan') ?>">
                ...
                <div class="modal fade" id="modaledit<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="post" action="<?= base_url('app/edit_pendapatan') ?>">
                         <input type="hidden" name="id" value="<?= $data['id'] ?>">
                         <input type="hidden" name="jml2" value="<?= $data['jml'] ?>">

                         <div class="form-group">
                          <label>Nama pendapatan</label>
                          <input type="text"  name="nama_pendapatan" value="<?= $data['nama_pendapatan'] ?>" class="form-control" required>
                        </div>
